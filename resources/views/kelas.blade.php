        ...
        <div class="card-body">
          <div class="mb-3 mb-sm-0">
            ...
            <div class="row">
              ...
              @endphp
              <div id="card" class="col mt-4 d-flex justify-content-center" data-id="{{ $kelas->id }}" data-nama_kelas="{{ $kelas->nama_kelas }}" data-nuptk="{{ $kelas->nuptk }}">
                  <article class="card__kelas rounded">
                      <div class="card__media">
                          <img src="{{ $kelas->gambar ?? '../assets/images/blog/blog-img'. $gambarIndex .'.jpg' }}" alt="Gambar Kelas">
                      </div>
